...
export const PDFNotificar = ({datos, setDatos, electronico, empresa}) =>{
            ...
            return(
                <Document>
                    <Page size="LEGAL" style={styles.page2.body}>
                        ...
                        <Text style={styles.page2.cuerpo}>Domicilio <Text style={{ color: 'red', fontFamily: 'Courier-Bold'}}>N° {`${empresa}`}</Text></Text>
