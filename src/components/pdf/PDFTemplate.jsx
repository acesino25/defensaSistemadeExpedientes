    ...
    return(
        <Document>
            <Page size="LEGAL" style={styles.body}>
                ...
                <Text style={styles.header}>{`${datos.empresas}`}</Text>
                ...
                <Text style={styles.headerPie2}>DENUNCIA Nº {`${datos.idEspecial}`}/{`${yyyy[2]}${yyyy[3]}`}</Text>
                ...
                <Text style={styles.page2.cuerpo}>Atento lo normando por la Ley Provincial Nº 5069, Ley Nacional Nº 24.240 y normas provinciales complementarias, supletoria (Ley N° 3559 y C.P.C.C.) y Resolución M.I.C.E Nº97/21, CÓRRASE TRASLADO de la presente denuncia  a la firma <Text style={{ color: 'red', fontFamily: 'Courier-Bold'}}>{`${datos.empresas}`}</Text> , la que quedará intimada para que en el plazo de DIEZ (10) días desde la notificación de la presente providencia FORMULE PROPUESTA CONCILIATORIA respecto de la pretensión del denunciante (art. 11 de la Ley N° 5.069), a cuyos efectos deberá enviar un correo electrónico a la Mesa de Entrada Virtual del Organismo en mesadeentradadefensa@catamarca.gov.ar.</Text>
                ...
                <Text style={{...styles.page2.pie.expediente,  color: 'red', fontFamily: 'Courier-Bold'}}>DENUNCIA Nº {`${datos.idESpecial}`}/{`${yyyy[2]}${yyyy[3]}`}</Text>
